...
Generate .docx files with JavaScript, then validate. Install: `npm install docx`
...
Use Times New Roman for academic papers. Keep titles black for readability.

```javascript
const doc = new Document({
  styles: {
    default: { document: { run: { font: "Times New Roman", size: 24 } } }, // 12pt default
    paragraphStyles: [
